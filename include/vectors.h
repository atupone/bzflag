...
template<> inline double typed_cos<double>(double rads)
{
    return cos(rads);
}

template <typename T> T typed_sin(T rads);
template<> inline float  typed_sin<float> (float  rads)
{
    return sinf(rads);
}
template<> inline double typed_sin<double>(double rads)
{
    return sin(rads);
}

template <typename T> T typed_sqrt(T rads);
template<> inline float  typed_sqrt<float> (float  rads)
{
    return sqrtf(rads);
}
template<> inline double typed_sqrt<double>(double rads)
{
    return sqrt(rads);
}
...
public:
    ...
    static void rotate(vec2& v, T radians)
    {
        v = v.rotate(radians);
    }
...
template <typename T> vec2<T> operator+(T d, const vec2<T>& in)
{
    vec2<T> v(in);
    v += d;
    return v;
...
public:
    ...
    inline       vec2<T>& xy()
    {
        return *(new((void*)&x) vec2<T>(false));
    }
    ...
    inline       vec2<T>& yz()
    {
        return *(new((void*)&y) vec2<T>(false));
    }
    inline const vec2<T>& yz() const
    {
        return *(new((void*)&y) vec2<T>(false));
    }
    ...
    static void rotateX(vec3& v, T radians)
    {
        v = v.rotateX(radians);
    }
    ...
    static void rotateY(vec3& v, T radians)
    {
        v = v.rotateY(radians);
    }
    ...
    static void rotateZ(vec3& v, T radians)
    {
        v = v.rotateZ(radians);
    }
...
template <typename T> vec3<T> operator+(T d, const vec3<T>& in)
{
    vec3<T> v(in);
    v += d;
    return v;
...
public:
    ...
    inline vec4& operator=(const T v[4])
    {
        x = v[0];
        y = v[1];
        z = v[2];
    ...
    inline       vec2<T>&  zw()
    {
        return *(new((void*)&z) vec2<T>(false));
    }
    inline const vec2<T>&  zw() const
    {
        return *(new((void*)&z) vec2<T>(false));
    }
    inline       vec3<T>& xyz()
    {
        return *(new((void*)&x) vec3<T>(false));
    }
    ...
    inline       vec3<T>& yzw()
    {
        return *(new((void*)&y) vec3<T>(false));
    }
    inline const vec3<T>& yzw() const
    {
        return *(new((void*)&y) vec3<T>(false));
    }
...
template <typename T> vec4<T> operator+(T d, const vec4<T>& in)
{
    vec4<T> v(in);
    v += d;
    return v;
...
inline fvec3 Float3ToVec3 ( const float * f)
{
    return fvec3(f[0],f[1],f[2]);
}
inline fvec4 Float3ToVec4 ( const float * f)
{
    return fvec4(f[0],f[1],f[2],1.0f);
}
inline fvec4 Float4ToVec4 ( const float * f)
{
    return fvec4(f[0],f[1],f[2],f[3]);
}
