 ...
 * with every copy.
 *
 * To compute the message digest of a chunk of bytes, create and MD5, call
 * MD5::update as needed on buffers full of bytes, and then call MD5::finalize,
 * which will fill the 16-byte array digest.
 *
