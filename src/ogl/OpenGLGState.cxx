...
public:
    ...
    bool        getNeedsSorting()
    {
        return state.getNeedsSorting();
    }
    bool        isBlended()
    {
        return state.isBlended();
    }
    bool        isTextured()
    {
        return state.isTextured();
    }
    bool        isTextureMatrix()
    {
        return state.isTextureMatrix();
    }
    bool        isSphereMap()
    {
        return state.isSphereMap();
    }
    bool        isLighted()
    {
        return state.isLighted();
    }
    void        setState();
    ...
    const OpenGLGStateState& getState() const
    {
        return state;
    }
...
{
    if (sorted.hasTexture && !shaderDestroyed)
    ...
    if (sorted.hasSphereMap)
        SHADER.setTexGen(SHADER.texGenNone);
    ...
    if (oldState)
    {
        ...
        if (sorted.hasSphereMap)
        {
            if (!oldState->sorted.hasSphereMap)
                SHADER.setTexGen(SHADER.texGenSphereMap);
        }
        else
        {
            if (oldState->sorted.hasSphereMap)
