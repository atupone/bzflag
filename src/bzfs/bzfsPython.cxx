...
static PyObject *bzPython_EventData;
...
static PyObject *bzPython_getNumFlags(PyObject *, PyObject *);
static PyObject *bzPython_flagPlayer(PyObject *, PyObject *);
static PyObject *bzPython_getCurrentTime(PyObject *, PyObject *);
static PyObject *bzPython_getFlagName(PyObject *, PyObject *);
static PyObject *bzPython_resetFlag(PyObject *, PyObject *);
static PyObject *bzPython_debugMessage(PyObject *, PyObject *);
static PyObject *bzPython_getDebugLevel(PyObject *, PyObject *);
static PyObject *bzPython_setMaxWaitTime(PyObject *, PyObject *);
static PyObject *bzPython_hasPerm(PyObject *, PyObject *);
static PyObject *bzPython_revokePerm(PyObject *, PyObject *);
static PyObject *bzPython_getAdmin(PyObject *, PyObject *);
static PyObject *bzPython_sendTextMessage(PyObject *, PyObject *);
static PyObject *bzPython_addServerSidePlayer(PyObject *, PyObject *);
static PyObject *bzPython_removeServerSidePlayer(PyObject *, PyObject *);
static PyObject *bzPython_sendServerCommand(PyObject *, PyObject *);
static PyObject *bzPython_RegisterCustomFlag(PyObject *, PyObject *);
static PyObject *bzPython_getPlayerByIndex(PyObject *, PyObject *);
static PyObject *bzPython_getPlayerIDByName(PyObject *, PyObject *);
static PyObject *bzPython_incrementPlayerWins(PyObject *, PyObject *);
static PyObject *bzPython_getPlayerFlagID(PyObject *, PyObject *);
static PyObject *bzPython_getPlayerFlag(PyObject *, PyObject *);
static PyObject *bzPython_removePlayerFlag(PyObject *, PyObject *);
static PyObject *bzPython_getTeamCount(PyObject *, PyObject *);
static PyObject *bzPython_getPlayerIndexList(PyObject *, PyObject *);
static PyObject *bzPython_getPublic(PyObject *, PyObject *);
static PyObject *bzPython_getClientWorldDownloadURL(PyObject *, PyObject *);
static PyObject *bzPython_getWorldCacheSize(PyObject *, PyObject *);
static PyObject *bzPython_getWorldCacheData(PyObject *, PyObject *);
static PyObject *bzPython_getPublicAddr(PyObject *, PyObject *);
static PyObject *bzPython_getPublicPort(PyObject *, PyObject *);
static PyObject *bzPython_setClientWorldDownloadURL(PyObject *, PyObject *);
...
static PyMethodDef bzfsItfMethods[] =
{
    ...
    {
        "bz_getPublic", bzPython_getPublic, METH_VARARGS,
        "Is server publicly reachable"
    },
    {
        "bz_getClientWorldDownloadURL", bzPython_getClientWorldDownloadURL,
        METH_VARARGS, "get Download URL"
    },
    {
        "bz_getWorldCacheSize", bzPython_getWorldCacheSize,
        METH_VARARGS, "get World Cache Size"
    },
    {
        "bz_getWorldCacheData", bzPython_getWorldCacheData,
        METH_VARARGS, "get World Cache Data"
    },
    {
        "bz_getPublicAddr", bzPython_getPublicAddr,
        METH_VARARGS, "get Public Address"
    },
    {
        "bz_getPublicPort", bzPython_getPublicPort,
        METH_VARARGS, "get Public Port"
    },
    {
        "bz_setClientWorldDownloadURL", bzPython_setClientWorldDownloadURL,
        METH_VARARGS, "set Client URL"
    },
...
void initPython (int argc, char **argv)
{
    ...
    bzPython_EventData = PyObject_GetAttrString(
                             bzfsItf_mod,
                             "bz_EventData");
    if (!bzPython_EventData)
    {
        Py_ExitStatusException(status);
        return;
    }
...
static PyObject *
bzPython_getPublic(PyObject *, PyObject *)
{
    if (bz_getPublic())
        Py_RETURN_TRUE;
    else
...
static PyObject *
bzPython_getClientWorldDownloadURL(PyObject *, PyObject *)
{
    const char *URL = bz_getClientWorldDownloadURL().c_str();
    if (URL)
...
static PyObject *
bzPython_getWorldCacheSize(PyObject *, PyObject *)
{
    const unsigned int cacheSize = bz_getWorldCacheSize();
    return PyLong_FromLong(cacheSize);
}

static PyObject *
bzPython_getWorldCacheData(PyObject *, PyObject *)
{
    size_t mapDataSize = bz_getWorldCacheSize();
    if (!mapDataSize)
        Py_RETURN_NONE;

    char *mapData = (char *)malloc(mapDataSize);
    if (!mapData)
        Py_RETURN_NONE;

    if (!bz_getWorldCacheData((unsigned char*)mapData))
        Py_RETURN_NONE;

    std::string md5 = bz_MD5(mapData, mapDataSize);

    PyObject *data = PyBytes_FromStringAndSize(mapData, mapDataSize);
    free(mapData);
    ...
    PyTuple_SetItem(pArgs, 1, PyUnicode_FromString(md5.c_str()));
...
static PyObject *
bzPython_getPublicAddr(PyObject *, PyObject *)
{
    return PyUnicode_FromString(bz_getPublicAddr().c_str());
}

static PyObject *
bzPython_getPublicPort(PyObject *, PyObject *)
{
    return PyLong_FromLong(bz_getPublicPort());
}

static PyObject *
bzPython_setClientWorldDownloadURL(PyObject *, PyObject *args)
{
    const char *URL;
...
static PyObject *genEvent (bz_EventData &data)
{
    PyObject *pArg = PyLong_FromLong((unsigned long)data.eventType);
    if (!pArg)
        return nullptr;

    PyObject *pEvent = PyObject_CallFunctionObjArgs(bzPython_EventData,
                       pArg,
                       NULL);
    Py_DECREF(pArg);
    return pEvent;
