...
bool ShockwaveLogic::CollideBox ( Shot& shot, glm::vec3 &center, glm::vec3 &size, float rotation )
{
...
bool ShockwaveLogic::CollideSphere ( Shot& shot, glm::vec3 &center, float radius )
{
    glm::vec3 vecToPoint = center - shot.StartPosition;
    return vecToPoint.length() <= shot.LastUpdatePosition.x - radius;
}

bool ShockwaveLogic::CollideCylinder ( Shot& shot, glm::vec3& center, float height, float radius )
{
